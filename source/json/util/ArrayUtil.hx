...
; return !contains
; } )
; } /** * Return true only if both arrays contain the same elements (possibly in a different order). * @param a The first array to compare. * @param b The second array to compare. * @return Weather both arrays contain the same elements.
...
; } return true
; } /** * Return the list of items which are present in both `list` and `intersect`. * @param list * @param intersect * @return
