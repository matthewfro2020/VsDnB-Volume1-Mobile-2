...
{ switch (op)
{ case "==": return compare_equal(left, right)
; case "!=": return compare_notEqual(left, right)
; case ">": return compare_greaterThan(left, right)
; case ">=": return compare_greaterThanOrEqual(left, right)
; case "<": return compare_lessThan(left, right)
; case "<=": return compare_lessThanOrEqual(left, right)
; default: throw 'Unknown comparison operator: $
{ op
} '
; }
} static function compare_equal(left:PrimitiveLiteral, right:PrimitiveLiteral):Bool
{ switch (left)
{ case ObjectLiteral(value): switch (right)
{ case ObjectLiteral(rightValue): return thx.Dynamics.equals(value, rightValue)
...
; } case ArrayLiteral(value): switch (right)
{ case ArrayLiteral(rightValue): return thx.Dynamics.equals(value, rightValue)
...
// Type mismatch return false
; } case NodelistLiteral(value): switch (right)
{ case NodelistLiteral(rightValue): return thx.Dynamics.equals(value, rightValue)
...
// Type mismatch return false
; } case StringLiteral(value): switch (right)
{ case StringLiteral(rightValue): return value == rightValue
...
// Type mismatch return false
; } case NumberLiteral(value): switch (right)
{ case NumberLiteral(rightValue): return value == rightValue
; case IntegerLiteral(rightValue): return value == rightValue
; case StringLiteral(_) | BooleanLiteral(_) | NullLiteral | UndefinedLiteral | NothingLiteral:
// Type mismatch return false
; case ObjectLiteral(_) | ArrayLiteral(_) | NodelistLiteral(_):
// Type mismatch return false
; } case IntegerLiteral(value): switch (right)
{ case IntegerLiteral(rightValue): return value == rightValue
; case NumberLiteral(rightValue): return rightValue == value
; case StringLiteral(_) | BooleanLiteral(_) | NullLiteral | UndefinedLiteral | NothingLiteral:
// Type mismatch return false
; case ObjectLiteral(_) | ArrayLiteral(_) | NodelistLiteral(_):
// Type mismatch return false
; } case BooleanLiteral(value): switch (right)
{ case BooleanLiteral(rightValue): return value == rightValue
; case StringLiteral(_) | NumberLiteral(_) | IntegerLiteral(_) | NullLiteral | UndefinedLiteral | NothingLiteral:
// Type mismatch return false
; case ObjectLiteral(_) | ArrayLiteral(_) | NodelistLiteral(_):
// Type mismatch return false
; } case NullLiteral: switch (right)
{ case ArrayLiteral(value):
// return value.length == 0
; return false
; case NullLiteral: return true
; case NothingLiteral: return true
; case UndefinedLiteral: return false
; default: return false
; } case UndefinedLiteral: switch (right)
{ case ArrayLiteral(value): return value.length == 0
; case UndefinedLiteral: return true
; case NothingLiteral: return true
; case NullLiteral: return false
; default: return false
; } case NothingLiteral: switch (right)
{ case ArrayLiteral(value): return value.length == 0
; case NothingLiteral: return true
; case NullLiteral: return true
; case UndefinedLiteral: return true
