...
*/ @:default('Unknown Stage') public var name:String
; /** * The default camera zoom for this stage.
*/ @:default(1) public var zoom:Float
...
; /** * Initalize a new StageData object. * @param name The name of the stage. * @param zoom The camera zoom of the stage.
...
; } /** * Serializes this StageData object into a json string. * @return A StageData JSON string.
...
*/ @:default([1, 1]) var scroll:Array<Float>
; /** * The camera offsets for this character.
*/ @:default([0, 0]) var cameraOffsets:Array<Float>
; }
