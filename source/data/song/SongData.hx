...
*/ @:alias('gf') @:default('gf') public var girlfriend:String
...
; } /** * Serializes this SongMetadata object into a json string. * @return A SongMetadata JSON string.
...
; /** * A list of all of the notes in the song. * Separated via measure sections.
*/ @:default([]) public var notes:Array<SongSection>
; /** * Initalizes a new chart data. * @param speed The speed of the chart. * @param notes A list of all notes.
*/ public function new(speed:Float, notes:Array<SongSection>)
{ this.version = SongRegistry.CHART_DATA_VERSION
; this.speed = speed
; this.notes = notes
; } /** * Serializes this SongChartData object into a json string. * @return A SongChartData JSON string.
*/ public function serialize():String
...
; } @:op(A == B) public function op_equals(other:SongNoteData):Bool
{ return this.time == other.time && this.direction == other.direction && this.length == other.length && this.type == other.type && this.noteStyle == other.noteStyle
; } @:op(A != B) public function op_notEquals(other:SongNoteData):Bool
{ return this.time != other.time || this.direction != other.direction || this.length != other.length || this.type != other.type || this.noteStyle != other.noteStyle
; } @:op(A > B) public function op_greaterThan(other:SongNoteData):Bool
{ return this.time > other.time
; } @:op(A < B) public function op_lessThan(other:SongNoteData):Bool
{ return this.time < other.time
; } @:op(A >= B) public function op_greaterThanOrEquals(other:SongNoteData):Bool
{ return this.time >= other.time
; } @:op(A <= B) public function op_lessThanOrEquals(other:SongNoteData):Bool
{ return this.time <= other.time
; }
...
*/ @:optional @:default('') public var type:String
; /** * The style/skin of this note.
*/ @:default('normal') @:alias('style') public var noteStyle:String
; /** * Initalizes a new note data. * @param time The time the note should be hit at. * @param direction The direction of the note. * @param length How long the note is. * @param type What type of note this is. * @param style The style of this note.
*/ public function new(time:Float, direction:Int, length:Float = 0.0, type:String = '', style:String = 'normal')
{ this.time = time
; this.direction = direction
; this.length = length
; this.noteStyle = style
; } /** * Gets the actual direction of this note data. * @return A number between 0-3.
*/ public function getDirection():Int
{ return direction % 4
; } public function toString():String
{ return 'SongNoteData(time: $
{ time
} , direction: $
{ direction
} , length: $
...
; } @:op(A == B) public function op_equals(other:SongTimeChange):Bool
{ return this.time == other.time && this.bpm == other.bpm && this.numerator == other.numerator && this.denominator == other.denominator
; } @:op(A != B) public function op_notEquals(other:SongTimeChange):Bool
{ return this.time != other.time || this.bpm != other.bpm || this.numerator != other.numerator || this.denominator != other.denominator
; } @:op(A > B) public function op_greaterThan(other:SongTimeChange):Bool
{ return this.time > other.time
; } @:op(A < B) public function op_lessThan(other:SongTimeChange):Bool
{ return this.time < other.time
; } @:op(A >= B) public function op_greaterThanOrEquals(other:SongTimeChange):Bool
{ return this.time >= other.time
; } @:op(A <= B) public function op_lessThanOrEquals(other:SongTimeChange):Bool
{ return this.time <= other.time
; }
...
; /** * The time at which this time changes happens, in steps. * Automatically calculated when mapped.
*/ @:jignored public var stepTime:Float
; /** * The time at which this time changes happens, in beats. * Automatically calculated when mapped.
*/ @:jignored public var beatTime:Float
; /** * The time at which this time changes happens, in measure. * Automatically calculated when mapped.
*/ @:jignored public var measureTime:Float
; public function new(time:Float, bpm:Float, numerator:Int = 4, denominator:Int = 4)
{ this.time = time
; this.bpm = bpm
...
; } /** * A data object containing metadata for external music. * Ex. Menu music, game over music, etc.
*/ class SongMusicData
...
*/ public var timeChanges:Array<SongTimeChange>
; public function toString():String
{ return 'SongMusicData($name version: $version, composers: $
{ composers
} )'
; }
}
