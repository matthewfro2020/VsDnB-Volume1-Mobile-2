...
; }
} /** * Saves the score for a song. * @param song The song to save the score to. * @param score The score the user got.
...
{ setScore(song, score)
; }
} /** * Saves the user's total week score. * @param week The week to save to. * @param score The score the user got.
...
{ setScore(weekString, score)
; }
} /** * Sets the score for a song to save into the game's data. * @param song The song to save to. * @param score The score to save.
*/ public static function setScore(song:String, score:Int):Void
{ songScores.set(song, score)
; FlxG.save.data.songScores = songScores
; FlxG.save.flush()
; } /** * Gets the score for a song. Saves to 0 if none exist. * @param song The song to save to. * @param score The score to save.
*/ public static function getScore(song:String):Int
{ if (!songScores.exists(song))
{ setScore(song, 0)
; } return songScores.get(song)
; } /** * Gets the score for the given week. Saves to 0 if none exist. * @param week The week to get the score for. * @return The week's score.
