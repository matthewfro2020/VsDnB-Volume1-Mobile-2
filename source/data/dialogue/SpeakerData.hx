...
*/ @:default([0, 0]) public var globalOffsets:Array<Float>
...
*/ @:default([]) public var expressions:Array<SpeakerExpressionData>
; public function new()
{
...
{ /** * The name/id of this expression. * This is what'll be used to retrieve this data.
*/ public var name:String
