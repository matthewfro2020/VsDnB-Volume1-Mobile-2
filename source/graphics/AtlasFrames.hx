 ...
 * Supports: spritemap1.json, spritemap2.json, etc.
 *
 * Returns regular FlxAtlasFrames (Psych-compatible)
 */
class AtlasFrames {
	/**
	 * Loads all spritemap{i}.json + its PNG into a combined FlxAtlasFrames.
	 */
