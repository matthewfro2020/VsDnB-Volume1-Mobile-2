...
{ // Set this value to false automatically, as the actual visibility for this icon already gets updated on portrait selection update. portrait.gfIcon.visible = false
; }
}
}
