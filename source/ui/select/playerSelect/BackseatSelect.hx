...
{ gf: 'tristan-gf', portraitFile: 'tristan_portrait', unselected:
{ name: 'idle_unselect', prefix: 'unselected_tristan', loop: true
} , selected:
{ name: 'idle_select', prefix: 'selected_tristan', loop: true
} , unselectedTransition:
{ name: 'idle', prefix: 'transitionu_tristan'
} , selectedTransition:
{ name: 'selected', prefix: 'transitions_tristan'
} , page: 0, position: 0
} var playrobotBackseat = new PlayerData('Playrobot', 'playrobot-backseat')
; playrobotBackseat.charSelect =
{ portraitFile: 'playrobot_portrait', gf: 'playrobot-gf', unselected:
{ name: 'idle_unselect', prefix: 'unselected_playrobot', loop: true
} , selected:
{ name: 'idle_select', prefix: 'selected_playrobot', loop: true
} , unselectedTransition:
{ name: 'idle', prefix: 'transitionu_playrobot'
} , selectedTransition:
{ name: 'selected', prefix: 'transitions_playrobot'
} , page: 0, position: 0
