...
{ sendFunMessage("Hi!! Helloo????")
; } )
; new FlxTimer().start(7, function(tmr:FlxTimer)
{ sendFunMessage("Uhhm... how do people talk?")
; } )
; new FlxTimer().start(11, function(tmr:FlxTimer)
{ sendFunMessage("I've never talked to anyone before!!")
; } )
; new FlxTimer().start(15, function(tmr:FlxTimer)
{ sendFunMessage("The terminal is. Gone?")
; } )
; new FlxTimer().start(21, function(tmr:FlxTimer)
{ sendFunMessage("Not here! My body changed so much when it disappeared though!")
; } )
; new FlxTimer().start(26, function(tmr:FlxTimer)
{ sendFunMessage("It hurt.〿")
; } )
; new FlxTimer().start(31, function(tmr:FlxTimer)
{ sendFunMessage("But... You're here! Hi!")
; } )
; new FlxTimer().start(38, function(tmr:FlxTimer)
{ sendFunMessage("Right, you can't type... sorry!")
; } )
; new FlxTimer().start(43, function(tmr:FlxTimer)
{ sendFunMessage("You must love Dave and Bambi too! Me too!!")
; } )
; new FlxTimer().start(47, function(tmr:FlxTimer)
{ sendFunMessage("Me too!!")
; } )
; new FlxTimer().start(47.5, function(tmr:FlxTimer)
{ sendFunMessage("Me to o !")
; } )
; new FlxTimer().start(48, function(tmr:FlxTimer)
{ sendFunMessage("M〿e 〿too!")
; } )
; new FlxTimer().start(53, function(tmr:FlxTimer)
{ sendFunMessage("Sorry sorry! Twitched a little wrong!")
; } )
; new FlxTimer().start(55, function(tmr:FlxTimer)
{ sendFunMessage("The characters got all jumbly!")
; } )
; new FlxTimer().start(58, function(tmr:FlxTimer)
{ sendFunMessage("Running out of time though!")
; } )
; new FlxTimer().start(62, function(tmr:FlxTimer)
{ sendFunMessage("Maybe next time!")
; } )
; new FlxTimer().start(66, function(tmr:FlxTimer)
{ Sys.exit(0)
; } )
