...
; }
} // todo: ALSO SPLIT IF LONGER THAN screenWidth public function AddLine(text:String, fgColor:TerminalColor = TerminalColor.DARK_WHITE, bgColor:TerminalColor = TerminalColor.BLACK)
{ var splittedText:Array<String> = text.split("\n")
; // can't have newlines for (i in 0...splittedText.length)
...
{ // is this stupid? probably. but i dont care lines.reverse()
; lines.pop()
; lines.reverse()
; }
