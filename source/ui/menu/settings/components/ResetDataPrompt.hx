...
; add(yes)
; yes.setPosition(questionText.x + questionText.textField.width + 50, questionText.y + (yes.textField.textHeight - questionText.textField.textHeight) / 2)
