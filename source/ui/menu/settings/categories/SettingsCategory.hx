...
{ // Return the first option that's available. if (option.canInteract)
{ return ind
; }
} return -1
...
{
} /** * The name of the category that'll be displayed in the settings menu. * @return String
...
; if (curOptionSelected < 0) curOptionSelected = list.length - 1
; if (curOptionSelected > list.length - 1) curOptionSelected = 0
