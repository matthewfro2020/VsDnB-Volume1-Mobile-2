...
{ name: LanguageManager.getTextString('settings_ui_minimalUI'), description: LanguageManager.getTextString('settings_ui_minimalUI_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_ui_debugUI'), description: LanguageManager.getTextString('settings_ui_debugUI_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_ui_timerType'), description: LanguageManager.getTextString('settings_ui_timerType_description'), options: [ LanguageManager.getTextString('settings_ui_timerType_timeLeft'), LanguageManager.getTextString('settings_ui_timerType_timeElapsed'), LanguageManager.getTextString('settings_ui_timerType_timeElapsedLeft'), ], optionsID: ['timeLeft', 'timeElapsed', 'elapsedAndLeft'], selectCallback: function(value:String)
...
{ name: LanguageManager.getTextString('settings_ui_warnings'), description: LanguageManager.getTextString('settings_ui_warnings_description'), callback: function(value:Bool)
...
; // Need to do this last so everything is initalized. checkbox_minimalUI.setChecked(Preferences.minimalUI, false, true)
