...
{ name: LanguageManager.getTextString('settings_general_downscroll'), description: LanguageManager.getTextString('settings_general_downscroll_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_general_ghostTapping'), description: LanguageManager.getTextString('settings_general_ghostTapping_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_general_cutscenes'), description: LanguageManager.getTextString('settings_general_cutscenes_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_general_botplay'), description: LanguageManager.getTextString('settings_general_botplay_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_general_keybinds'), description: LanguageManager.getTextString('settings_general_keybinds_description'), callback: function()
