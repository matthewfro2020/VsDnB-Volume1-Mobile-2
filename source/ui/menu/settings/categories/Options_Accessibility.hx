...
{ name: LanguageManager.getTextString('settings_accessibility_flashingLights'), description: LanguageManager.getTextString('settings_accessibility_flashingLights_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_accessibility_cameraShaking'), description: LanguageManager.getTextString('settings_accessibility_cameraShaking_description'), callback: function(value:Bool)
...
{ name: LanguageManager.getTextString('settings_accessibility_camNoteMove'), description: LanguageManager.getTextString('settings_accessibility_camNoteMove_description'), callback: function(value:Bool)
