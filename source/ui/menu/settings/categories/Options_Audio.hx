...
{ name: LanguageManager.getTextString('settings_audio_masterVolume'), description: LanguageManager.getTextString('settings_audio_masterVolume_description'), min: 0.00, max: 1.00, callback: function(value:Float)
...
{ name: LanguageManager.getTextString('settings_audio_musicVolume'), description: LanguageManager.getTextString('settings_audio_musicVolume_description'), min: 0.00, max: 1.00, callback: function(value:Float)
...
{ name: LanguageManager.getTextString('settings_audio_voices'), description: LanguageManager.getTextString('settings_audio_voices_description'), min: 0.00, max: 1.00, callback: function(value:Float)
...
{ name: LanguageManager.getTextString('settings_audio_sfx'), description: LanguageManager.getTextString('settings_audio_sfx_description'), min: 0.00, max: 1.00, callback: function(value:Float)
...
{ name: LanguageManager.getTextString('settings_audio_hitsounds'), description: LanguageManager.getTextString('settings_audio_hitsounds_description'), min: 0.00, max: 1.00, callback: function(value:Float)
