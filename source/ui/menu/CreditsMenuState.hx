...
; // TRANSLATORS var windspel:CreditsPerson
...
; #if mobileC addVirtualPad(UP_DOWN, B)
; #end super.create()
...
{ var blackBg = FlxGradient.createGradientFlxSprite(FlxG.width, FlxG.height, [ FlxColor.interpolate(FlxColor.fromRGB(0, 0, 0), 0xFF4965FF, 0.4), FlxColor.interpolate(FlxColor.fromRGB(0, 0, 0), 0xFF00B515, 0.4) ], 1, 180)
...
{ name: 'MoldyGangstaHero', description: getLanguageText('credits_moldy'), icon: 'developers/MoldyGH'
} )
; developersGroup.add(moldy)
; rapparep = new CreditsPerson(175, 150,
{ name: 'Rapparep', description: getLanguageText('credits_rapparep'), icon: 'developers/rapparep lol'
} )
; developersGroup.add(rapparep)
; t5mpler = new CreditsPerson(900, 175,
{ name: 'T5mpler', description: getLanguageText('credits_t5mpler'), icon: 'developers/T5mpler'
} )
; developersGroup.add(t5mpler)
; mtm101 = new CreditsPerson(100, 350,
{ name: 'MissingTextureMan101', description: getLanguageText('credits_mtm101'), icon: 'developers/MissingTextureMan101'
} )
; developersGroup.add(mtm101)
; erizur = new CreditsPerson(550, 350,
{ name: 'Erizur', description: getLanguageText('credits_erizur'), icon: 'developers/Erizur'
} )
; developersGroup.add(erizur)
; tb = new CreditsPerson(875, 375,
{ name: 'TheBuilderXD', description: getLanguageText('credits_tb'), icon: 'developers/TheBuilderXD', antialiasing: false
} )
; developersGroup.add(tb)
; longdonny = new CreditsPerson(325, 530,
{ name: 'LongDonny', description: getLanguageText('credits_longDonny'), icon: 'developers/jo'
} )
; developersGroup.add(longdonny)
; fissh = new CreditsPerson(775, 520,
{ name: 'fissh', description: getLanguageText('credits_fissh'), icon: 'developers/fissh'
} )
...
{ name: 'evdial', description: getLanguageText('credits_evdial'), icon: 'contributors/evdial'
} )
; contributorsGroup.add(evdial)
; billy = new CreditsPerson(400, 150,
{ name: 'Billy Bobbo', description: getLanguageText('credits_billy'), icon: 'developers/Billy Bobbo',
} )
; contributorsGroup.add(billy)
; steph = new CreditsPerson(700, 150,
{ name: 'Steph45', description: getLanguageText('credits_steph'), icon: 'contributors/Steph45'
} )
; contributorsGroup.add(steph)
; sk0rbias = new CreditsPerson(925, 145,
{ name: 'sk0rbias', description: getLanguageText('credits_sk0rbias'), icon: 'contributors/sk0rbias'
} )
; contributorsGroup.add(sk0rbias)
; alexanderCooper19 = new CreditsPerson(60, 290,
{ name: 'Alexander Cooper 19', description: getLanguageText('credits_alexander'), icon: 'contributors/Alexander Cooper 19'
} )
; contributorsGroup.add(alexanderCooper19)
; magical = new CreditsPerson(700, 300,
{ name: 'Magical', description: getLanguageText('credits_magical'), icon: 'contributors/magical'
} )
; contributorsGroup.add(magical)
; bubswest = new CreditsPerson(975, 300,
{ name: 'bubswest', description: getLanguageText('credits_bubswest'), icon: 'contributors/bubswest'
} )
; contributorsGroup.add(bubswest)
; cup = new CreditsPerson(425, 300,
{ name: 'Cup', description: getLanguageText('credits_cup'), icon: 'contributors/Cup'
} )
; contributorsGroup.add(cup)
; sibottle = new CreditsPerson(125, 425,
{ name: 'SiBottle', description: getLanguageText('credits_sibottle'), icon: 'contributors/sibottle'
} )
; contributorsGroup.add(sibottle)
; top10 = new CreditsPerson(400, 425,
{ name: 'Top 10 Awesome', description: getLanguageText('credits_top10'), icon: 'contributors/Top 10 Awesome', scale: 0.8,
} )
; contributorsGroup.add(top10)
; inguf = new CreditsPerson(700, 410,
{ name: 'Inguf341', description: getLanguageText('credits_inguf'), icon: 'contributors/inguf341'
} )
; contributorsGroup.add(inguf)
; ztgds = new CreditsPerson(1000, 425,
{ name: 'ztgds', description: getLanguageText('credits_ztgds'), icon: 'contributors/ztgds'
} )
; contributorsGroup.add(ztgds)
; yourMom = new CreditsPerson(825, 570,
{ name: 'Your Mom', description: getLanguageText('credits_yourMom'), icon: 'contributors/Your mom'
} )
; contributorsGroup.add(yourMom)
; zmac = new CreditsPerson(300, 575,
{ name: 'Zmac', description: getLanguageText('credits_zmac'), icon: 'developers/Zmac', antialiasing: false
} )
; contributorsGroup.add(zmac)
; erin = new CreditsPerson(525, 555,
{ name: 'pointyyESM', description: getLanguageText('credits_pointy'), icon: 'developers/pointy'
} )
...
{ name: 'Windspel', description: getLanguageText('credits_windspel'), icon: 'translators/windspel'
} )
; translatorsGroup.add(windspel)
; aizakku = new CreditsPerson(555, 90,
{ name: 'Aizakku', description: getLanguageText('credits_aizakku'), icon: 'translators/Aizakku'
} )
; translatorsGroup.add(aizakku)
; soulegal = new CreditsPerson(825, 75,
{ name: 'Soulegal', description: getLanguageText('credits_soulegal'), icon: 'translators/Soulegal'
} )
...
{ name: 'Villezen', description: getLanguageText('credits_villezen'), icon: 'contributors/Villezen'
} )
; specialThanksGroup.add(villezen)
; shifty = new CreditsPerson(625, 85,
{ name: 'ShiftyTM', description: getLanguageText('credits_shifty'), icon: 'contributors/ShiftyTM'
} )
; specialThanksGroup.add(shifty)
; statictigers = new CreditsPerson(225, 210,
{ name: 'Statictigers', description: getLanguageText('credits_statictigers'), icon: 'contributors/statictigers'
} )
; specialThanksGroup.add(statictigers)
; sky = new CreditsPerson(520, 215,
{ name: 'SkyFactorial', description: getLanguageText('credits_skyFactorial'), icon: 'contributors/Sky!'
} )
; specialThanksGroup.add(sky)
; ray = new CreditsPerson(825, 210,
{ name: 'Ray', description: getLanguageText('credits_ray'), icon: 'contributors/ray'
} )
...
; var iconGraphic = Paths.image('credits/$
{ params.icon
} ')
; if (iconGraphic == null) iconGraphic = Paths.image('credits/placeholder')
; var icon = new FlxSprite().loadGraphic(Paths.image('credits/$
{ params.icon
} '))
