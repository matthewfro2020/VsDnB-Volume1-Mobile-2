...
; #else var textString:String = LanguageManager.getTextString('intro_warning_mobile')
; #end public override function create()
...
{ #if mobile for (touch in FlxG.touches.list) if (touch.justPressed) justTouched = true
; #end if (FlxG.keys.justPressed.ENTER #if mobile || justTouched #end)
