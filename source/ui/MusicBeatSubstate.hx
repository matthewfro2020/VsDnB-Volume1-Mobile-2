...
; import flixel.FlxG;
;
; import scripting.ScriptEventDispatchSubState;
;
...
*/ class MusicBeatSubstate extends ScriptEventDispatchSubState
...
; #if mobileC var virtualPad:FlxVirtualPad
...
{ #if linux Sys.command('/usr/bin/xdg-open', [schmancy, "&"])
; #else FlxG.openURL(schmancy)
; #end
} override function destroy()
{ removeSignals()
; #if mobileC if (trackedInputsVirtualPad.length > 0) controls.removeVirtualControlsInput(trackedInputsVirtualPad)
; #end super.destroy()
