...
class into the container's entry data to customize how this subtitle looks, and behaves.
...
; /** * Initalize a new Subtitle. * * @param data The data this subtitle belongs to. * @param manager The manager this subtitle is contained to.
