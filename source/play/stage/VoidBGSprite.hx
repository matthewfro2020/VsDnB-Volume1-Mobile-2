...
*/ var ?amplitude:Float
; } /** * A BGSprite that uses a void shader. * Normally used for 3D-related songs.
...
; #if (SHADERS_ENABLED || mac) glitchShader = new RuntimeShader(Paths.frag('glitchEffect'))
...
; } /** * Validates the given parameters so they're able to be used. * @param params The parameters to validate. * @return A new VoidParams.
*/ function validateParams(params:VoidParams):VoidParams
{ if (params == null) params =
{ speed: 2, frequency: 5, amplitude: 0.1
}
; if (params.speed == null) params.speed = 2
; if (params.frequency == null) params.frequency = 5
; if (params.amplitude == null) params.amplitude = 0.1
; return params
