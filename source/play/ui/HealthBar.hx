...
*/ parent:Dynamic,
/** * The variable to base the health bar's percent on. * This should be referenced from the `parent` object.
*/ variable:String,
/** * The minimum value of the health bar.
*/ min:Float,
/** * The maximum value for the health bar.
*/ max:Float,
/** * The scroll type for the health bar. * Changes the y position based on whether it's upscroll, or downscroll.
*/ scrollType:String,
...
; } /** * Updates the colors of the health bar for the given players. * @param opponent The opponent character to use the colors of the left side. * @param player The player character to use the colors of the right side.
