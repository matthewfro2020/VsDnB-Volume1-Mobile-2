...
; /** * The priority this module has when calling scripts. * A lower priority will mean this module will be called first in favor of other attached song modules.
*/ public var priority(default, set):Int
; function set_priority(value:Int):Int
{ priority = value
; SongModuleHandler.reorderModules()
; return value
; } /** * Whether this module is currently active, and running. * Disabling will mean this module will not be dispatched and have any of its scripted classes called.
*/ public var enabled(default, null):Bool = true
; /** * The current PlayState instance so it's easily accessible for scripts.
*/ var game:PlayState
; /** * Creates a new SongModule instance. * @param moduleId The id of the module. * @param songId The id of the song for this module to run on. * @param variationId The variation of this module to run on.
