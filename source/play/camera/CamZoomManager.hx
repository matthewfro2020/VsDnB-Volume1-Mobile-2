...
; /** * Whether the camera's zoom is able to be controlled by it's associated property. * Ex. Having this false on `camGame` would make it not be controlled by `defaultCamZoom`
