...
; /** * The amount of priority this module has in terms of other modules. * This determines what modules are called first, and which are called last. * * A module with a priority of `0` will be called before a module with a priority of `100`, etc.
...
; /** * Creates a new module. * @param id The id of the module. * @param priority The priority of the module.
