...
; } /** * Returns a string representation of the `Stats` object. * * @return A string containing all the properties of the `Stats` object.
...
; return parts.join(', ')
; } /** * Constructs a `Stats` object from raw LibVLC media statistics. * * @param media_stats The LibVLC media statistics. * @return A `Stats` object populated with the provided media statistics.
*/ @:unreflective public static function fromMediaStats(media_stats:Struct<LibVLC_Media_Stats_T>):Stats
