...
; public function clear() this.o =
{
}
; /** It gets the value at the specified key. *
*/ public function get(k:String):Null<V> return Reflect.field(o, k)
; /** Null-safe get *
*/ public function getOption(k:String):haxe.ds.Option<V> return Options.ofValue(get(k))
; /** `getObject` returns the undetlying anonymous object. *
*/ public inline function getObject():
{
} return o
; /** It sets the value at the specified key. *
*/ public function set(k:String, v:V):Void Reflect.setField(o, k, v)
; /** It returns true if the object contains a field with key `k`. *
*/ public function exists(k:String):Bool return Reflect.hasField(o, k)
; /** It removes the field `k` from the underlying obejct. The function returns `true` if the removal was successful. *
*/ public function remove(k:String):Bool return Reflect.deleteField(o, k)
; /** It returns an iterator of strings containing all the field keys in the object. *
*/ public function keys():Iterator<String> return Reflect.fields(o).iterator()
; /** It returns an iterator of values in the object. *
*/ public function iterator():Iterator<V> return keys().fmap(Reflect.field.bind(o, _))
