...
{ this = [length]
; // store the BitSet length at block index 0 #if !js
// resizing is not needed in JS but might still be a good idea var size = Std.int(length / blockSize) + 1
...
*/ @:from public static inline function fromBools(values:Array<Bool>):BitSet
{ return Arrays.reducei(values, function(acc:BitSet, value, i)
{ acc.setAt(i, value)
; return acc
; } , new BitSet(0))
; } /** Converts a string of 0s and 1s (e.g. "10101") to a BitSet *
*/ @:from public static inline function fromString(str:String):BitSet
{ var chars = str.split("")
...
*/ @:to public inline function toBools():Array<Bool>
{ return length.range().map(function(index)
{ return at(index)
; } )
; } @:to public inline function toInt32s():Array<Int32>
...
*/ @:arrayAccess public function at(index:Int):Bool
...
*/ @:arrayAccess public function setAt(index:Int, value:Bool):Bool
{ var blockIndex = Math.floor(index / blockSize) + 1
; if (blockIndex >= this.length)
{ Arrays.resize(this, blockIndex + 1, 0)
; }
; if (this[0] <= index) this[0] = index + 1
...
{ return at(index) ? '1' : '0'
; } ).join("")
; } /** ANDs together this BitSet with another BitSet. No changes are made to this BitSet. *
*/ #if (haxe_ver >= 3.300) @:op(A & B) #end public function and(right:BitSet):BitSet
{ return combine(right, function(l, r) return l && r)
; } /** ORs together this BitSet with another BitSet. No changes are made to this BitSet. *
*/ #if (haxe_ver >= 3.300) @:op(A | B) #end public function or(right:BitSet):BitSet
{ return combine(right, function(l, r) return l || r)
; } /** XORs together this BitSet with another BitSet. No changes are made to this BitSet. *
*/ #if (haxe_ver >= 3.300) @:op(A ^ B) #end public function xor(right:BitSet):BitSet
{ return combine(right, function(l, r) return (l && !r) || (!l && r))
; } /** Returns a new BitSet that is a bitwise negation of this BitSet. No changes are made to this BitSet. *
*/ #if (haxe_ver >= 3.200) @:op(~A) #end public function negate():BitSet
{ return Arrays.reduce(length.range(), function(acc:BitSet, i)
{ acc.setAt(i, !at(i))
; return acc
; } , new BitSet(0))
; } @:op(A == B) public function equals(other:BitSet):Bool
{ if (length != other.length) return false
; for (i in 0...length)
{ if (at(i) != other.at(i)) return false
; } return true
; } @:op(A != B) public function notEquals(other:BitSet):Bool
{ return !equals(other)
