...
; } return bitMatrix
; } @:from public static function fromBools(input:Array<Array<Bool>>):BitMatrix
...
; return fromBitSets(bitSets)
; } @:to public function toBools():Array<Array<Bool>>
...
; } /** ANDs together this BitMatrix with another BitMatrix. No changes are made to this BitMatrix. *
*/ #if (haxe_ver >= 3.300) @:op(A & B) #end public function and(right:BitMatrix):BitMatrix
{ return combine(right, function(l, r) return l && r)
; } /** ORs together this BitMatrix with another BitMatrix. No changes are made to this BitMatrix. *
*/ #if (haxe_ver >= 3.300) @:op(A | B) #end public function or(right:BitMatrix):BitMatrix
{ return combine(right, function(l, r) return l || r)
; } /** XORs together this BitMatrix with another BitMatrix. No changes are made to this BitMatrix. *
*/ #if (haxe_ver >= 3.300) @:op(A ^ B) #end public function xor(right:BitMatrix):BitMatrix
{ return combine(right, function(l, r) return (l && !r) || (!l && r))
; } /** Returns a new BitMatrix that is the negation of this BitMatrix. No changes are made to this BitMatrix. *
*/ #if (haxe_ver >= 3.300) @:op(~A) #end public function negate():BitMatrix
...
; } @:op(A == B) public function equals(right:BitMatrix):Bool
{ var left:BitMatrix = this
...
; } return true
; } @:op(A != B) public function notEquals(right:BitMatrix):Bool
{ var left:BitMatrix = this
