...
*/ public static function compare(a:Bool, b:Bool) return a == b ? 0 : (a ? -1 : 1)
; /** Converts a boolean to an integer value (`true` => `1`, `false` => `0`).
*/ public static function toInt(v:Bool) return v ? 1 : 0
...
; case _: false
; } /** Returns `true`/`false` if the passed value is `true`/`false` (case insensitive)
; with any other value it will return null.
...
*/ inline public static function xor(a:Bool, b:Bool):Bool return a != b
; /** * Depending upon the condition, return the provided value wrapped * in a Some, or None if the condition is false.
*/ inline public static function option<A>(cond:Bool, a:A):Option<A> return if (cond) Some(a) else None
; }
