...
{ inline public static function success<TSuccess, TFailure>(value:TSuccess):Result<TSuccess, TFailure> return Either.Right(value)
; inline public static function failure<TSuccess, TFailure>(error:TFailure):Result<TSuccess, TFailure> return Either.Left(error)
...
*/ @:to public function optionValue():Option<TSuccess> return switch this
{ case Right(v): Some(v)
; case _: None
; }
...
*/ @:to public function optionError():Option<TFailure> return switch this
{ case Left(v): Some(v)
; case _: None
; }
; /** Converts `Result` into a nullable value of type TSuccess.
*/ @:to public function value():Null<TSuccess> return switch this
{ case Right(v): v
; case _: null
; }
; /** Converts `Result` into a nullable value of type TFailure.
*/ @:to public function error():Null<TFailure> return switch this
{ case Left(v): v
; case _: null
; }
; function get_isSuccess() return switch this
{ case Right(_): true
; case _: false
; }
; function get_isFailure() return switch this
{ case Left(_): true
; case _: false
; }
; }
