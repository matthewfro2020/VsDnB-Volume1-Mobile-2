...
*/ class Enums
{ /** Converts an
enum value into a `String` representation. *
*/ public static function string<T:EnumValue>(e:T)
{ var cons = Type.enumConstructor(e)
; var params = []
; for (param in Type.enumParameters(e)) params.push(Dynamics.string(param))
...
; } /** Compares two
enum instances for equality ignoring the constructor arguments. *
*/ inline public static function sameConstructor<T:EnumValue>(a:T, b:T):Bool return Type.enumIndex(a) == Type.enumIndex(b)
; /** Returns the lower between two
enum instances. Sequence is determined by their index in the type definition. *
*/ public static function min<T:EnumValue>(a:T, b:T):T
{ if (compare(a, b) < 0) return a
; else return b
; } /** Returns the higher between two
enum instances. Sequence is determined by their index in the type definition. *
