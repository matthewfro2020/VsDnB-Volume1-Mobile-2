...
{ case macro $i
{ name
} if (name == '_'): return macro __tmp0
; case macro $i
{ name
} if (name == '_0'): return macro __tmp0
; case macro $i
{ name
} if (name == '_1'): return macro __tmp1
; case macro $i
{ name
} if (name == '_2'): return macro __tmp2
; case macro $i
{ name
} if (name == '_3'): return macro __tmp3
; case macro $i
{ name
} if (name == '_4'): return macro __tmp4
...
{ case macro $i
{ name
} if (name.startsWith("_")): if (Std.parseInt(name.substr(1)) > cnt)
{ ++cnt
; // = Std.parseInt(name.substr(1))
; } default:
